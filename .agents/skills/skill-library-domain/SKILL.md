...
A community platform where developers share, discover, rate, and download skills for Codex and Codex. Similar to VS Code extensions marketplace or npm registry but for AI agent skills.
...
| Term | Meaning |
|------|---------|
| Skill | Reusable code asset (workflow, prompt, script) for Codex/Codex |
